...
public class MongoTest {
	...
	public void run() {
		...
		TestClass test = new TestClass("Test3", 23);
		
		bookCollection.insertOne(toDoc(test));
		/*
		TestClass test2 = toClass(bookCollection.find().first());
		System.out.println("Found: ");
		System.out.println("param: " + test2.getParam() + "\nvalue: " + test2.getValue());
		*/
		
		for (Document d : bookCollection.find()) {
